#include "CoveragePathPlanner/normal_astar_planner/dubins/node3d.h"
...
// R = 30, 6.75 DEG.    since we change cell size from 1m to 0.2m,
// something wried make us to change the R and DEG to 5*R and 5*DEG
//const float Node3D::dy[] = { 0,            -0.2772617218029,  0.2772617218029};
//const float Node3D::dx[] = { 4.70149589831,   4.70149589831,    4.70149589831};
//const float Node3D::dt[] = { 0,                   0.1178097,       -0.1178097};

// R = 40, 6.75 DEG.    since we change cell size from 1m to 0.2m,
// something wried make us to change the R and DEG to 5*R and 5*DEG
const float Node3D::dy[] = { 0,            -0.2079462913,  0.2079462913};
const float Node3D::dx[] = { 3.526121923,    3.526121923,   3.526121923};
const float Node3D::dt[] = { 0,                0.1178097,    -0.1178097};


// R = 50, 6.75 DEG.    since we change cell size from 1m to 0.2m,
// something wried make us to change the R and DEG to 5*R and 5*DEG
//const float Node3D::dy[] = { 0,            -0.3465771522,  0.3465771522};
//const float Node3D::dx[] = { 5.8768698728,  5.8768698728,  5.8768698728};
//const float Node3D::dt[] = { 0,                0.1178097,    -0.1178097};
...
//      i++;
//    } else {
//      //      LOG(INFO) << "Dubins shot collided, discarding the path" << "\n";
//      // delete all nodes
//      delete [] dubinsNodes;
//      return nullptr;
//    }
...
//  //  LOG(INFO) << "Dubins shot connected, returning the path" << "\n";
